...
function App() {
  ...
  const [silverSupply, setSilverSupply] = useState('0');
  const [diamondSupply, setDiamondSupply] = useState('0')
  ...
  const getData = async () => {
    if (blockchain.account !== "" && blockchain.smartContract !== null) {
      dispatch(fetchData(blockchain.account));
      const silverSpl = await blockchain.smartContract.methods._silverSupply().call()
      setSilverSupply(silverSpl.toString())
      const diamondSpl = await blockchain.smartContract.methods._diamondSupply().call()
      setDiamondSupply(diamondSpl.toString())
    }
  };
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            <s.SpacerSmall />
            {Number(silverSupply) >= CONFIG.SILVER_MAX_SUPPLY ? (
              <>
                <s.TextTitle
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
          ...
          >
            ...
            >
              {diamondSupply} Diamond / {CONFIG.DIAMOND_MAX_SUPPLY} Total
            </s.TextTitle>
            <s.TextDescription
              style={{
                textAlign: "center",
